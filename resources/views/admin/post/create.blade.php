                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="post_title_in"
                                    placeholder="Enter Hindi Post Title">
                            </div>
                        </div><!-- col-4 -->
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mg-b-10-force">
                                ...
                                <select class="form-control select2" data-placeholder="Choose Category" name="category_id">
                                    ...
                                    @foreach ($postcat as $row)
                                        <option value="{{ $row->id }}">{{ $row->category_name_in }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div><!-- col-4 -->
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label class="form-control-label">Post Details (English): <span
                                        class="tx-danger"></span></label>
                                <textarea class="form-control" name="details_en" id="summernote_en"></textarea>
                            </div>
                        </div><!-- col-4 -->
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label class="form-control-label">Post Details (Hindi): <span
                                        class="tx-danger"></span></label>
                                <textarea class="form-control" name="details_in" id="summernote_in"></textarea>
                            </div>
                        </div><!-- col-4 -->
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <label class="custom-file">
                                    <input type="file" id="file1" class="custom-file-input" name="post_image"

...
@section('admin')
            ...
            <form method="POST" action="{{ url('/update/product/withoutphoto', $product->id) }}" enctype="multipart/form-data">
                ...
                <div class="form-layout">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <label class="ckbox">
                                <input type="checkbox" name="hot_deal" value="1" <?php if ($product->hot_deal
                                == 1) {
                                echo 'checked';
                                } ?> >
                                <span>Hot Deal</span>
                        ...
                        <div class="col-lg-4">
                            <label class="ckbox">
                                <input type="checkbox" name="hot_new" value="1" <?php if ($product->hot_new
                                == 1) {
                                echo 'checked';
                                } ?> >
                                <span>Hot New </span>
    ...
    <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
            ...
            <form method="post" action="{{ url('/update/product/photo/' . $product->id) }} "
